        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-8">
              ...
              {/* Photos & Media */}
              {(selectedEstimate.photos && selectedEstimate.photos.length > 0) || (selectedEstimate.videos && selectedEstimate.videos.length > 0) ? (
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    {selectedEstimate.photos && selectedEstimate.photos.length > 0 && (
                      <div className="mb-6">
                        <h4 className="font-medium text-gray-900 mb-3">Photos ({selectedEstimate.photos.length})</h4>
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                          {selectedEstimate.photos.map((photoUrl: string, index: number) => (
                    ...
                    {selectedEstimate.videos && selectedEstimate.videos.length > 0 && (
                      <div>
                        <h4 className="font-medium text-gray-900 mb-3">Videos ({selectedEstimate.videos.length})</h4>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          {selectedEstimate.videos.map((videoUrl: string, index: number) => (
                            <div key={index} className="relative group">
