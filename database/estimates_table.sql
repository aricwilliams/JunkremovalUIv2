...
CREATE TABLE estimates (
    ...
    -- System Fields
    status ENUM('pending', 'reviewed', 'quoted', 'accepted', 'declined', 'expired') DEFAULT 'pending',
...
CREATE TABLE estimate_status_history (
    id INT PRIMARY KEY AUTO_INCREMENT,
    estimate_id INT NOT NULL,
    old_status ENUM('pending', 'reviewed', 'quoted', 'accepted', 'declined', 'expired') NULL,
    new_status ENUM('pending', 'reviewed', 'quoted', 'accepted', 'declined', 'expired') NOT NULL,
